...
export function ExpandableTabs({
  ...
  // WAI-ARIA tablist pattern: arrow keys move focus between tabs (wrapping),
  // Home/End jump to the first/last. Every tab stays its own Tab stop rather
  // than a strict roving tabindex, so this only adds a faster path.
  const handleTabKeyDown = useCallback(
    (event: ReactKeyboardEvent<HTMLButtonElement>, index: number) => {
      ...
      tabRefs.current[items[nextIndex].id]?.focus();
    },
    [items],
  );
